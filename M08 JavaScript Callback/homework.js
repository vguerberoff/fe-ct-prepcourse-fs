...
function sumarArray(arrayOfNumbers, cb) {
   ...
   var arraySumado= arrayOfNumbers.reduce(function(acumulador, elementoActual)
...
function map(array, cb) {
   ...
   var nuevoArreglo = [];
   array.map((elem)=> nuevoArreglo.push(cb(elem)));
   return nuevoArreglo;
}
...
function filter(arrayOfStrings) {
   ...
   var resultado = arrayOfStrings.filter(function(elem){
